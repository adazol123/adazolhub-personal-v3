...
<template>
  <div class="my-6">
    <span class="text-zinc-500 text-sm">Experiences</span>

    <div class="my-2">
      <ol class="relative border-s border-gray-200 dark:border-gray-700">
        <li class="mb-10 ms-6">
          <span
            class="absolute flex items-center justify-center w-6 h-6 bg-blue-100 rounded-full -start-3 ring-4 ring-white dark:bg-blue-900"
          >
            <IconCommunity class="w-2.5 h-2.5 text-blue-800 dark:text-blue-300" />
          </span>
        ...
        <li class="mb-10 ms-6">
          <span
            class="absolute flex items-center justify-center w-6 h-6 bg-blue-100 rounded-full -start-3 ring-8 ring-white dark:bg-blue-900"
          >
            <svg
